...
<style>
  ...
  .feed-star { display: inline-flex; width: 22px; height: 22px; align-items: center; justify-content: center; flex-shrink: 0; border: 0; border-radius: 5px; background: transparent; padding: 0; color: #4F5158; line-height: 1; cursor: pointer; }
