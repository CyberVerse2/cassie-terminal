...
<style>
  ...
  .back-button { display: inline-flex; align-items: center; gap: 6px; margin: 0 0 12px; padding: 0; border: 0; background: none; color: #9c9c9c; font: inherit; font-size: 13px; font-weight: 600; cursor: pointer; }
  .idea-view { width: 100%; animation: fadeUp 0.22s ease both; }
  .market-summary { display: flex; align-items: stretch; overflow-x: auto; border: 1px solid rgba(255,255,255,0.08); border-radius: 6px; background: #0b0b0b; }
  ...
  .market-logo { position: relative; display: flex; width: 38px; height: 38px; align-items: center; justify-content: center; flex-shrink: 0; overflow: hidden; border-radius: 4px; background: #191919; color: #cbcbcb; font-size: 12px; font-weight: 700; }
  .market-logo img { position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover; background: #191919; }
  .market-ticker { max-width: 220px; overflow: hidden; color: #eeeeee; font-size: 16px; font-weight: 700; letter-spacing: -0.01em; text-overflow: ellipsis; white-space: nowrap; }
  .market-route { margin-top: 3px; color: #797979; font-family: var(--font-ui); font-size: 10px; }
  ...
  .market-metric span { color: #797979; font-size: 10px; font-weight: 700; }
  .market-metric strong { margin-top: 5px; font-family: var(--font-mono); font-size: 15px; font-weight: 600; white-space: nowrap; }
  .price-error { margin-top: 10px; color: #FF78B8; font-size: 12px; }
  ...
  .author-link img { width: 34px; height: 34px; flex-shrink: 0; border-radius: 50%; object-fit: cover; background: #222222; }
  .author-name { color: #e3e3e3; font-size: 13px; font-weight: 600; }
  .author-name span { color: #797979; font-weight: 400; }
  .author-stats { margin-top: 2px; overflow: hidden; color: #949494; font-size: 11.5px; text-overflow: ellipsis; white-space: nowrap; }
  .source-link { display: inline-flex; align-items: center; gap: 4px; flex-shrink: 0; color: #B5F20B; font-size: 12px; font-weight: 600; text-decoration: none; }
  ...
  .tweet-group-head h2 { margin: 0; color: #d8d8d8; font-size: 11px; font-weight: 650; }
  .tweet-group-head > span { color: #686868; font-family: var(--font-ui); font-size: 9px; }
  ...
  .tweet-tile { display: grid; width: clamp(230px, 42%, 340px); height: 58px; flex: 0 0 auto; grid-template-columns: 34px minmax(0,1fr) auto; align-items: center; gap: 9px; border: 1px solid rgba(255,255,255,.08); border-radius: 4px; background: #111111; padding: 7px 11px; color: inherit; text-decoration: none; scroll-snap-align: start; }
  .tweet-tile:hover, .tweet-tile:focus-visible { border-color: rgba(181,242,11,.42); outline: none; }
  .tweet-tile > img { width: 34px; height: 34px; border-radius: 50%; background: #222222; object-fit: cover; }
  ...
  .tweet-tile-copy strong { overflow: hidden; color: #e3e3e3; font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }
  .tweet-tile-copy span { flex-shrink: 0; color: #6b6b6b; font-size: 8px; }
  .tweet-tile-copy p { overflow: hidden; margin: 0; color: #949494; font-size: 9.5px; text-overflow: ellipsis; white-space: nowrap; }
  .tweet-return { font-family: var(--font-mono); font-size: 11px; font-weight: 700; }
  .chart-card { margin-top: 10px; overflow: hidden; border: 1px solid rgba(255,255,255,0.07); border-radius: 0; background: #080808; }
  .chart-frame { height: clamp(360px, 32vw, 560px); }
  .detail-status { padding: 28px 0; color: #8c8c8c; font-size: 12px; }
  .detail-error { color: #FF78B8; }
  ...
  .thesis-header h1 { max-width: 68ch; margin: 12px 0 0; color: #f0f0f0; font-size: 19px; font-weight: 600; letter-spacing: -0.018em; line-height: 1.45; text-wrap: pretty; }
  .thesis-star { display: inline-flex; width: 26px; height: 26px; align-items: center; justify-content: center; border: 0; border-radius: 4px; background: rgba(255,255,255,.035); padding: 0; color: #525252; line-height: 1; cursor: pointer; }
  .thesis-star:hover, .thesis-star:focus-visible, .thesis-star.starred { outline: 0; color: #B5F20B; }
  .conviction-badge { display: inline-block; border: 1px solid; border-radius: 4px; padding: 3px 7px; font-size: 10px; font-weight: 700; text-transform: lowercase; }
  .brief-section { margin-top: 22px; padding-top: 18px; border-top: 1px solid rgba(255,255,255,0.08); }
  .brief-section h2 { margin: 0 0 15px; color: #eeeeee; font-size: 15px; font-weight: 700; }
  ...
  .driver-row > span { width: 6px; height: 6px; margin-top: 9px; flex-shrink: 0; border-radius: 50%; background: #B5F20B; }
  .driver-row p { max-width: 70ch; margin: 0; color: #c6c6c6; font-size: 13px; line-height: 1.6; text-wrap: pretty; }
  .counter-thesis > button { display: block; width: min(100%, 960px); border: 1px solid rgba(240,76,166,.24); border-radius: 6px; background: rgba(240,76,166,.045); padding: 18px; color: inherit; font: inherit; text-align: left; cursor: pointer; }
  .counter-thesis > button:hover, .counter-thesis > button:focus-visible { outline: 0; border-color: rgba(240,76,166,.5); background: rgba(240,76,166,.075); }
  .counter-source { display: flex; align-items: center; gap: 10px; }
  .counter-source img { width: 32px; height: 32px; border-radius: 50%; object-fit: cover; background: #191919; }
  .counter-source div { display: flex; min-width: 0; flex: 1; flex-direction: column; }
  .counter-source strong { color: #e3e3e3; font-size: 12px; }
  .counter-source span { margin-top: 2px; color: #797979; font-size: 10px; }
  .counter-source b { font-family: var(--font-ui); font-size: 10px; letter-spacing: .06em; }
  .counter-thesis h3 { margin: 15px 0 0; color: #e6e6e6; font-size: 17px; line-height: 1.4; }
  .counter-thesis p { max-width: 76ch; margin: 8px 0 0; color: #b0b0b0; font-size: 14px; line-height: 1.55; }
  .counter-open { display: inline-flex; align-items: center; gap: 5px; margin-top: 13px; color: #B5F20B; font-size: 11px; font-weight: 650; }
  .asset-lever-grid { display: grid; max-width: 960px; grid-template-columns: repeat(2, minmax(0,1fr)); gap: 12px; }
  .asset-lever-grid > div, .exposure-chain { border: 1px solid rgba(255,255,255,0.08); border-radius: 6px; background: #0d0d0d; padding: 16px 18px; }
  .asset-lever h3 { margin: 0; color: #919191; font-size: 10px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; }
  .asset-lever p { margin: 8px 0 0; color: #d1d1d1; font-size: 14px; line-height: 1.55; text-wrap: pretty; }
  ...
  .exposure-chain li > span { padding-top: 9px; color: #B5F20B; font-family: var(--font-ui); font-size: 9px; font-weight: 700; letter-spacing: .05em; text-transform: uppercase; }
